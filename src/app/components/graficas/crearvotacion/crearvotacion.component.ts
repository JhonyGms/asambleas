...
export class CrearvotacionComponent implements OnInit {
  ...
  constructor(public formBuilder: FormBuilder, public GraficasServices: GraficasService, public dialog: MatDialog) {}
  ...
  submit() {
    ...
    this.GraficasServices.qcrearvotacion(this.registerForm.value).subscribe(
      (res) => {
        const dialogref = this.dialog.open(ConfirmDialogComponent, {
          data: {
            title: 'Todo salio perfecto',
            text: 'Se ha podido crear la votacion de forma satisfactoria',
          },
        });
      ...
      (err) => {
        const dialogref = this.dialog.open(ConfirmDialogComponent, {
          data: {
            title: 'Paso algo',
            text: 'No se ha podido crear la votacion de forma satisfactoria',
          },
        });
        dialogref.afterClosed().subscribe((res) => {});
      }
